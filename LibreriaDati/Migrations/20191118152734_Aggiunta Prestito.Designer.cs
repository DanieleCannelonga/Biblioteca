...
namespace LibreriaDati.Migrations
{
    ...
    [Migration("20191118152734_Aggiunta Prestito")]
    partial class AggiuntaPrestito
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibreriaDati.Models.Video", b =>
                {
                    b.HasBaseType("LibreriaDati.Models.RisorseBiblioteca");

                    b.Property<string>("Direttore")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LibreriaDati.Models.RisorseBiblioteca", b =>
                {
                    ...
                    b.HasOne("LibreriaDati.Models.Libro", "ImmagineUrl")
                        .WithMany()
                        .HasForeignKey("ImmagineUrlId");
